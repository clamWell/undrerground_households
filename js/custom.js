$(function(){
	...
	var ploe_chart_config = {width: 1200, height: 500, margin: 10} ;
//	var all_city_data = all_city_data;
	
	var ploe_chart_svg = d3.select("#ALL_CITY_HOUSE_POLE").select("svg")
		.attr("width", ploe_chart_config.width +"px" )
		.attr("height", ploe_chart_config.height +"px")

	var chart_holder = ploe_chart_svg.append("g")
